...
INSERT INTO products (name, description, price) VALUES ('Celular', 'Iphone 11', 39.99);create table products (price float(53) not null, id bigint generated by default as identity, description varchar(255), name varchar(255) not null, primary key (id));
