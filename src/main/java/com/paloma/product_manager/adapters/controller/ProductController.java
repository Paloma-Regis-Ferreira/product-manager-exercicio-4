 ...
 * Single Responsibility Principle (SRP): A classe ProductController tem responsabilidade única de lidar com as requisições HTTP relacionadas aos produtos, não realizando nenhuma tarefa alem de chamar a service
 * Dependency Inversion Principle (DIP): O ProductController depende da interface ProductServiceUseCase, não de implementações concretas.
 *
